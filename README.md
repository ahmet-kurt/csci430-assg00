...
You need to complete the steps in the class development environment
setup instructions at
https://github.com/etamu-class/vscode-docker-devcontainer
...
## Create your Repository on GitHub from the Class Template

For all assignments you will be given a link to a class template
repository on GitHub that contains the starting code and instructions
for the assignment.  From the template repository you will create your
own private copy of the assignment repository in your GitHub account,
which you can then clone and push your work back into for grading.

Go to the class template repository for this practice assignment at

https://github.com/ahmet-kurt/csci430-assg00

and select "Use this template" -> "Create a new repository".  Make
sure that the owner of the new repository is your own GitHub account,
name your repository `assg00-lastname` (using your own last name), and
set the repository visibility to **Private**.

Once your repository is created, you need to add the instructor as a
collaborator so that your work can be reviewed and evaluated for
grading.  In your new repository, go to Settings -> Collaborators ->
Add people, and invite the instructor's GitHub account: `ahmet-kurt`.
All work for this class is individual work, do not add any other
collaborators to your assignment repositories.

## Clone Repository using SSH to a VSCode Dev Container

Your new repository on GitHub will be named something like
`assg00-lastname`, the name you gave it when you created it from the
...
1. Create your own private copy of the assignment repository from
   ...
   repository for 'Assignment Example: Example Workflow for Class Assignments' at

   https://github.com/ahmet-kurt/csci430-assg00

   and select "Use this template" -> "Create a new repository".  Make
   sure the owner is your own GitHub account, name your repository
   `assg00-lastname` (using your own last name), and set the
...
assignment to your GitHub repository.
...
**NOTE**: All assignments for this class use a `Feedback` pull
request for instructor review and grading feedback.  When you push
your first commit to your repository, a repository action will
automatically create a branch named `feedback` from the initial
starting state of your repository.  You will then open a pull request
from the `main` branch into the `feedback` branch, titled `Feedback`
(this was described in the setup steps above).  All work you do should
be pushed to the `main` branch of the repository.  The `Feedback` pull
request will automatically gather all commits pushed to the `main`
branch.  You can communicate with me, and I will give back comments on
the `Feedback` pull request of your progress for the assignment.  You
should not close or merge the `Feedback` pull request.  When I am
satisfied you have 100% completed an assignment, I will merge and
close the `Feedback` pull request for you.  This is an indication that
you have completed all parts of an assignment.  If the `Feedback` pull
request is still open, it means I have not yet accepted it fully, and
there may be comments or requirements from me for additional tasks or
items you need to fix before your work is considered 100% complete.
...
2. A zip archive of your final repository contents.  You can create
   ...
   `git archive --format=zip --output=assg00-submission.zip main`
